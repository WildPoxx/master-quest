...
export const AUTHORED_BY_BLUEPRINT = Object.freeze({
  quest: Object.freeze([
    ...
    // 1.5.0: o fluxo e direcao, e direcao vem da fonte — mesma regra do gmnotes
    // (DEC-028). Reimportar reescreve o fluxo a partir do blueprint; edicao de mesa
    // que deva sobreviver a fonte pertence ao blueprint, nao ao flag.
    "flow",
